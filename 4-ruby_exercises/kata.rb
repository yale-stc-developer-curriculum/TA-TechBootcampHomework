# Write a method greet(name) that takes one argument as name and then greets that name, 
...
# Your Task: Implement a function cooking_time(eggs), which takes a non-negative integer, 
